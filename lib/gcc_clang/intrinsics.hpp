...
inline bool add_overflow(index a, index b, index& result) { return __builtin_add_overflow(a, b, &result); }

inline bool mul_overflow(index a, index b, index& result) { return __builtin_mul_overflow(a, b, &result); }
